...
class TypeCustom extends StatefulWidget {
  @override
  _TypeCustomState createState() => _TypeCustomState();
}

class _TypeCustomState extends State<TypeCustom> {
  ...
  void onNumberPressed(int digit) {
    setState(() {
      ...
      paymentNotifier.currentPrice = (viewModel.number * 100).toInt();
    });
  }
  ...
  void onReturnPressed() {
    setState(() {
      viewModel.number = 0;
      paymentNotifier.currentPrice = 0;
      decimalMarker = 0;
    });
  }
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Text("${paymentNotifier.price / 100} €",
                  style: Theme.of(context).textTheme.bodyLarge),
            ],
          ),
        ),
